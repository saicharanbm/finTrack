...
function TransactionContainer({ range }: { range: RangeKey }) {
  ...
  //change pg no to 1 if the range changes
  useEffect(() => {
    setPage(1);
  }, [range]);
