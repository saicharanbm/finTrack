import { useCreateTransactionMutation } from "@/services/mutations";
import type {
  CategoriesType,
...
type Props = {
  parsedTransactions: TransactionSchemaType[] | undefined;
  setUserMessage: React.Dispatch<React.SetStateAction<string>>;
  setParsedTransactions: React.Dispatch<
    React.SetStateAction<TransactionSchemaType[] | undefined>
  >;
  setAiMessage: React.Dispatch<
...
export default ParsedTransactions;
